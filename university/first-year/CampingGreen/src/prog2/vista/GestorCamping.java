...
public class GestorCamping {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "El número total d'allotjaments del Càmping és " + campingMar.getNumAllotjaments()
                + " dels quals " + campingMar.calculAllotjamentsOperatius()
                + " allotjaments estan operatius"
        );
        ...
        try {
            System.out.println(
                    "L'allotjament amb estada mínima de la temporada alta més curta és el següent: "
                            + campingMar.getAllotjamentEstadaMesCurta(InAllotjament.Temp.ALTA).getId()
            );
